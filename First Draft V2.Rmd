...
# Plot 1: Distribution of Overdraft Protection
ggplot(clean_credit_card, aes(x = Overdraft_Protection, fill = Offer_Accepted)) +
  geom_bar(position = "dodge") +
  theme_minimal() +
  labs(title = "Distribution of Overdraft Protection by Offer Acceptance", 
       x = "Overdraft Protection", y = "Count") +
...
credit_data_clean$predicted_prob <- predict(enhanced_offer_model, newdata = credit_data_clean, type = "response")
